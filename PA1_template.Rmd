...
```
The mean total number of steps taken per day was `r mean(steps_all_days$day_steps)`.  The median total number of steps taken per day was `r median(steps_all_days$day_steps)`.
